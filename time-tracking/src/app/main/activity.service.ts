...
export class ActivityService {
  ...
  deleteActivity(
    ...
    this.http
      .post('https://iu-time-tracking-api.click/api/activities/delete', deletionData, {
  ...
  getAllActivities(
    ...
    if (!userId) {
      this.http
        .get<Activity[]>(
          'https://iu-time-tracking-api.click/api/activities/' + queryParams,
          {
            withCredentials: true,
          }
        )
    ...
    this.http
      .get<Activity[]>(
        'https://iu-time-tracking-api.click/api/activities/' + userId + queryParams
      )
      .subscribe((response) => {
        this.activitiesSubj.next(response);
      });
  ...
  getAllActivitiesNoQueryParams(userId: string | undefined) {
    if (!userId) {
      this.http
        .get<Activity[]>('https://iu-time-tracking-api.click/api/activities/', {
          withCredentials: true,
        })
        .subscribe((response) => {
    ...
    this.http
      .get<Activity[]>('https://iu-time-tracking-api.click/api/activities/' + userId)
      .subscribe((response) => {
        this.activitiesSubjNoQueryParams.next(response);
      });
  }
